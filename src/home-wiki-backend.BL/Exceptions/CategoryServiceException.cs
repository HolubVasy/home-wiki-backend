...
namespace home_wiki_backend.BL.Exceptions
{
    ...
    /// </summary>
    public sealed class CategoryServiceException : ExceptionBase
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CategoryServiceException"/> class.
        /// </summary>
        ...
        public CategoryServiceException(string message, Exception inner)
            : base(message, inner)
        {
        }
    }
